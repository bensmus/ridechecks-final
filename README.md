...
This is an application made for an amusement park administrator that allows them to make a ride check schedule. A ride check schedule assigns mechanics (workers) to check amusement park rides before the park opens. A sample schedule generated by the application is shown below. 
